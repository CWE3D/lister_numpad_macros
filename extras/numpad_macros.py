...
DEFAULT_READ_TIMEOUT = 0.5  # Increased from 0.1
...
class NumpadMacros:
    def __init__(self, config) -> None:
        ...
        # Get configuration values - must set debug_log early
        ...
        default_print_allowed = "key_dot,key_dot_alt,key_grave,key_enter,key_enter_alt"
